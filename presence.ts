...
presence.on('UpdateData', async () => {
    ...
    curLocation = document.location.pathname,
    ...
    if (hostName === "dscjobs.org") {
        ...
        if (curLocation === '/') {
            ...
            const [modPage] = document.location.href.split('page=')[1].split('&'),
            ...
            const [devPage] = document.location.href.split('page=')[1].split('&'),
            filters = document.location.href.includes('&');
            ...
            const cvPage = document.querySelector("h2.cursor")?.getAttribute("data-title"),
                  likes = document.getElementById("likes_amount")?.getAttribute("data-title"),
                  views = document.getElementById("views_amount")?.getAttribute("data-title");
